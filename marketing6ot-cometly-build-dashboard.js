...
function campaignTableRows(rows, showBudget) {
  ...
  return rows.map(r => {
    ...
    const evStr = r.ev > 0
      ...
      : '—';
    const spentStr = r.spent > 0 ? `$${r.spent.toFixed(1)}` : '—';
    const budgetStr = r.budget !== null ? `$${r.budget.toFixed(1)}/day` : '—';
...
<div class="container">
  ...
  <div class="kpi-row" style="margin-top:24px">
    ...
    <div class="kpi green"><label>Loan Apps</label><div class="value">${grandTotals.totalApps.toFixed(1)}</div><div class="sub">Submitted</div></div>
  ...
  <div class="kpi-row">
    ...
    <div class="kpi green"><label>Loan Apps</label><div class="value">${metaTotals.totalApps.toFixed(1)}</div></div>
    ...
    <table>
      ...
      <tfoot>
        <tr>
          ...
          <td class="num">${metaTotals.totalApps > 0 ? metaTotals.totalApps.toFixed(1) : '—'}</td>
  ...
  <div class="kpi-row">
    ...
    <div class="kpi green"><label>Loan Apps</label><div class="value">${googleTotals.totalApps.toFixed(1)}</div></div>
    ...
    <table>
      ...
      <tfoot>
        <tr>
          ...
          <td class="num">${googleTotals.totalApps > 0 ? googleTotals.totalApps.toFixed(1) : '—'}</td>
...
<footer>
  The Hard Money Co. · ${DATE_RANGE} · ${dateLabel} · Powered by Mark &amp; Cometly · Generated ${SCRAPE_TIME.toLocaleString('en-US', { timeZone: 'America/Chicago' })}
</footer>
</body>
</html>`;
