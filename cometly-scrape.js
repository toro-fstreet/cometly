...
async function selectMarkPreset(page) {
  ...
  if (!tbPos) { console.log('    ⚠ Mark preset not found (no right-side match)'); return false; }
  ...
  if (tbPos === 'scroll-needed') {
    ...
    if (!tbPos2) { console.log('    ⚠ Mark preset not in viewport after scroll'); return false; }
  ...
  console.log('    ✓ Mark preset applied');
  return true;
}
